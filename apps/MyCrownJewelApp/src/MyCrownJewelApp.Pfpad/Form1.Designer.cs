...
partial class Form1
{
    ...
    private ToolStripMenuItem aiopsQueryMenuItem;
    private ToolStripMenuItem aiopsTimelineMenuItem;
    private ToolStripMenuItem aiopsPrRiskMenuItem;
    private ToolStripMenuItem aiopsServiceDepMenuItem;
    private ToolStripMenuItem aiopsRunbookMenuItem;
    ...
    private ToolStripMenuItem aiopsOtelMenuItem;
    ...
    private void InitializeComponent()
    {
        ...
        var gotoDefMenuItem = new ToolStripMenuItem("Go to &Definition", null, GoToDefinition_Click, Keys.F12) { Tag = "cs" };
        editMenu.DropDownItems.Add(gotoDefMenuItem);
        var renameMenuItem = new ToolStripMenuItem("&Rename...", null, Rename_Click, Keys.F2) { Tag = "cs" };
        editMenu.DropDownItems.Add(renameMenuItem);
        var callHierarchyMenuItem = new ToolStripMenuItem("Call &Hierarchy", null, CallHierarchy_Click, Keys.Control | Keys.Shift | Keys.H) { Tag = "cs" };
        ...
        var goToSymbolWsItem = new ToolStripMenuItem("Go to S&ymbol in Workspace...", null, GoToSymbolInWorkspace_Click, Keys.Control | Keys.Shift | Keys.O) { Tag = "cs" };
        goMenu.DropDownItems.Add(goToFileItem);
        goMenu.DropDownItems.Add(goToSymbolWsItem);
        goMenu.DropDownItems.Add(new ToolStripSeparator());
        var goToSymbolEdItem = new ToolStripMenuItem("Go to Symbol in &Editor...", null, GoToSymbolInEditor_Click, Keys.Control | Keys.OemPeriod) { Tag = "cs" };
        var goToDefItem = new ToolStripMenuItem("Go to &Definition", null, GoToDefinition_Click, Keys.F12) { Tag = "cs" };
        var goToDeclItem = new ToolStripMenuItem("Go to &Declaration", null, GoToDeclaration_Click, Keys.Control | Keys.F12) { Tag = "cs" };
        var goToTypeDefItem = new ToolStripMenuItem("Go to &Type Definition", null, GoToTypeDefinition_Click) { Tag = "cs" };
        var goToImplItem = new ToolStripMenuItem("Go to &Implementations", null, GoToImplementations_Click) { Tag = "cs" };
        var goToRefsItem = new ToolStripMenuItem("Go to &References", null, GoToReferences_Click, Keys.Shift | Keys.F12) { Tag = "cs" };
        ...
        panelMenu.DropDownItems.Add(new ToolStripSeparator());
        var dependenciesMenuItem = new ToolStripMenuItem("&Dependencies", null, Dependencies_Click, Keys.Control | Keys.Alt | Keys.D) { Tag = "cs" };
        panelMenu.DropDownItems.Add(dependenciesMenuItem);
        var impactMenuItem = new ToolStripMenuItem("&Impact Analysis", null, ImpactAnalysis_Click, Keys.Control | Keys.Alt | Keys.I) { Tag = "cs" };
        panelMenu.DropDownItems.Add(impactMenuItem);
        panelMenu.DropDownItems.Add(new ToolStripSeparator());
        var runConfigMenuItem = new ToolStripMenuItem("Run &Configurations", null, ToggleRunConfigPanel, Keys.Control | Keys.F5) { Tag = "cs" };
        ...
        aiopsQueryMenuItem = new ToolStripMenuItem("AI &Query...", null, AIOpsQuery_Click, Keys.Control | Keys.Alt | Keys.Q);
        aiopsTimelineMenuItem = new ToolStripMenuItem("&Incident Timeline", null, AIOpsTimeline_Click, Keys.Control | Keys.Alt | Keys.L);
        aiopsPrRiskMenuItem = new ToolStripMenuItem("&PR Risk Analysis", null, AiopsPrRisk_Click, Keys.Control | Keys.Alt | Keys.P);
        aiopsServiceDepMenuItem = new ToolStripMenuItem("Service &Dependencies", null, AIOpsServiceDep_Click, Keys.Control | Keys.Alt | Keys.W);
        aiopsRunbookMenuItem = new ToolStripMenuItem("&Runbooks", null, AIOpsRunbooks_Click, Keys.Control | Keys.Alt | Keys.B);
        ...
        aiopsMenu.DropDownItems.Add(aiopsQueryMenuItem);
        aiopsMenu.DropDownItems.Add(aiopsTimelineMenuItem);
        aiopsMenu.DropDownItems.Add(aiopsPrRiskMenuItem);
        aiopsMenu.DropDownItems.Add(aiopsServiceDepMenuItem);
        aiopsMenu.DropDownItems.Add(aiopsRunbookMenuItem);
        ...
        aiopsOtelMenuItem = new ToolStripMenuItem("Generate &OTel Code", null, AIOpsOtelCode_Click, Keys.Control | Keys.Alt | Keys.G);
        ...
        aiopsMenu.DropDownItems.Add(aiopsOtelMenuItem);
        aiopsMenu.DropDownItems.Add(new ToolStripSeparator());
