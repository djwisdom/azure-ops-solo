...
This directory contains the installer files for Personal Flip Pad version 1.0.30.0.

## Building the Installer

### Prerequisites

1. **.NET 8 SDK** - For publishing the application
...
- Try running the installer as Administrator for per-machine installation
