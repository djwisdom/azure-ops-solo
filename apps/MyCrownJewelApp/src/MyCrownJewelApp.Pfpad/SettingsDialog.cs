...
internal sealed class SettingsDialog : Form
{
    ...
    private void ApplyCurrentSettings()
    {
        var settings = new AppSettings
        {
            ...
            WorkspaceVisible = _mainForm.CurrentWorkspaceVisible,
            SymbolPanelVisible = _mainForm.CurrentSymbolPanelVisible,
            ProblemsPanelVisible = _mainForm.CurrentProblemsPanelVisible,
            TerminalVisible = _mainForm.CurrentTerminalVisible,
            TerminalHeight = _mainForm.CurrentTerminalHeight,
