...
AppVersion=1.0.39.0
AppVerName=Personal Flip Pad 1.0.39.0
...
OutputDir=.
OutputBaseFilename=PersonalFlipPad-Setup-1.0.39.0
...
Root: HKCU; Subkey: "Software\Classes\Folder\shellex\ContextMenuHandlers\MyCrownJewelApp.Pfpad"; ValueType: string; ValueData: ""; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\Directory\Background\shellex\ContextMenuHandlers\MyCrownJewelApp.Pfpad"; ValueType: string; ValueData: ""; Flags: uninsdeletekey

; Add to "Open with" list for all files
Root: HKCU; Subkey: "Software\Classes\*\OpenWithProgids\MyCrownJewelApp.Pfpad"; ValueType: string; ValueData: ""; Flags: uninsdeletekey
...
Root: HKCU; Subkey: "Software\Microsoft\PersonalFlipPad"; ValueType: string; ValueName: "Version"; ValueData: "1.0.39.0"; Flags: uninsdeletekey
